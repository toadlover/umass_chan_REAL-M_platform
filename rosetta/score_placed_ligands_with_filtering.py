...
for r,d,f in os.walk(location):
	for file in f:
		...
		if file.endswith(".pdb") and "minipose" not in file:
			...
			raw_score_file.write(r + "/placements/" + file + "," + str(ddg[0]) + "," + str(total_motifs[0]) + "," + str(significant_motifs[0]) + "," + str(real_motif_ratio[0]) + "," + str(hbond_motif_count[0]) + "," + str(hbond_motif_energy_sum[0]) + "," + str(closest_autodock_recovery_rmsd[0]) + "," + str(closest_autodock_recovery_ddg[0]) + "," + str(strain_energy[0]) + "," + str(total[0]) + "\n")
			weighted_score_file.write(r + "/placements/" + file + "," + str(ddg[1]) + "," + str(total_motifs[1]) + "," + str(significant_motifs[1]) + "," + str(real_motif_ratio[1]) + "," + str(hbond_motif_count[0]) + "," + str(hbond_motif_energy_sum[0]) + "," + str(closest_autodock_recovery_rmsd[1]) + "," + str(closest_autodock_recovery_ddg[1]) + "," + str(strain_energy[1]) + "," + str(total[1]) + "\n")
